...
public class WSCorreiosCalculadorTest {
    ...
    public void calculaPrecosEPrazos() {
        final List<CServico> servicos = ws.calculaPrecoPrazo(Arrays.asList("40010"), "88101250", "89893000", BigDecimal.valueOf(1.5), Formato.CAIXA, BigDecimal.valueOf(25), BigDecimal.valueOf(25), BigDecimal.valueOf(25), null, Opcao.NAO, BigDecimal.valueOf(25), Opcao.NAO);
